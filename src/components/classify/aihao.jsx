...
class Aihao extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      items:[],
    ...
    componentDidMount() {
        // 解决跳转到此页面时,滚动条不在最顶端
        document.getElementById("aihao").scrollIntoView(true);
    ...
    render(){
        return(
            <div className={scssObj.classlistLayout} id="aihao">
            <div className="container">
              <div className="row">
                ...
                <Link to="/keji" className="list-group-item list-group-item-action ">
                  ...
                  <Link to="/aihao" className="list-group-item list-group-item-action active">爱好</Link>
