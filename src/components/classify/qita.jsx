...
class Qita extends React.Component{
  ...
  componentDidMount() {
    // 解决跳转到此页面时,滚动条不在最顶端
    document.getElementById("qita").scrollIntoView(true);
    ...
    render(){
        return(
            <div className={scssObj.classlistLayout} id="qita">
            <div className="container">
              <div className="row">
                ...
                <Link to="/keji" className="list-group-item list-group-item-action">
                  ...
                  <Link to="/qita" className="list-group-item list-group-item-action active">其他</Link>
                </div> 
                </div>
                <div className="col-7">
